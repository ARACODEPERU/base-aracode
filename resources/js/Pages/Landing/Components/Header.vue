        ...
        <nav class="border-gray-200 py-2">
            <div
                ...
                <Link :href="route('index_main')" class="flex items-center">
                    <img v-if="company.isotipo == '/img/isotipo.png'" :src="company.isotipo" class="w-auto h-[30px]" alt="Logo">
                    <img v-else :src="`${xassetUrl}storage/${dataHeader.items[0].item.content}`" class="w-auto h-[30px]" alt="Logo2">
                </Link>
