...
<template>
    <header class="bg-white">
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                <dropdown>
                    <template #trigger="{ toggle }">
                        <button type="button" class="flex items-center gap-x-1 text-sm/6 font-semibold text-gray-900" @click="toggle">
                            Product
                    ...
                    <div class="dropdown-div absolute -left-8 top-full mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
                        <div class="p-4">
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <Link :href="route('login')" class="text-sm/6 font-semibold text-gray-900">Acceso <span aria-hidden="true">&rarr;</span></Link>
            </div>
        </nav>
    ...
    <header class="bg-gray-800 w-full py-0 my-0">
        <div class="container">
            <nav class=" bg-gray-800 flex justify-between lg:justify-start items-center">
                ...
                <button class="rounded-full bg-blue-500 font-bold px-4 py-2 text-white hover:text-black hover:bg-white transition duration-500">
