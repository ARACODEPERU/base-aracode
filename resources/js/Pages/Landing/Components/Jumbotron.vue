...
<template>
    <section id="home" class="section-hero bg-[#f6f8ff] relative dark:bg-[#161321]">
        <img ref="shape1" class="shape1 absolute w-12 left-72 bottom-36 parallax sm:block hidden" :src="`${xassetUrl}themes/personalLanding/assets/img/shape/shape-1.png`" alt="shape-1">
        <img ref="shape2" class="shape2 absolute w-12 top-72 right-32 parallax top sm:block hidden" :src="`${xassetUrl}themes/personalLanding/assets/img/shape/shape-2.png`" alt="shape-2">
        <img ref="shape3" class="shape3 absolute w-12 top-48	left-96 parallax left top sm:block hidden" :src="`${xassetUrl}themes/personalLanding/assets/img/shape/shape-3.png`"
            alt="shape-3">
