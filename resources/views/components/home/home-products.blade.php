                ...
                <div class="col-lg-12">
                    <div class="owl-carousel owl-theme owl-3-dots wow mask-right">
                        ...
                        <div class="item">
                            ...
                            <a class="btn-main fx-slide w-100" href="{{ route('solucion_kapta') }}"><span>Más Información</span></a>
                        </div>
                        <!-- ticket item end -->
                        ...
                        <div class="item">
                            ...
                            <div class="relative overflow-hidden">
                                ...
                                <a class="btn-main fx-slide w-100" href="{{ route('solucion_facturacion') }}"><span>Más Información</span></a>
