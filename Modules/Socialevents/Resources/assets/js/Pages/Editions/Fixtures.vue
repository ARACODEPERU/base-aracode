...
import IconX from '@/Components/vristo/icon/icon-x.vue';
    ...
    const exportImage = async () => {
        ...
        try {
            ...
            link.download = `fixture-${new Date().getTime()}.png`
            link.href = dataUrl
            link.click()
    ...
    <AppLayout title="Ediciones">
        ...
        <div class="pt-5">
                ...
                <div class="w-full">
                    <div class="flex flex-col sm:flex-row items-center justify-end gap-4">
                        <button @click="exportImage" class="btn btn-danger uppercase text-xs">
                            <IconLoader v-if="loaderImage" class="w-4 h-4 mr-1" />
                            Exportar imagen
                        </button>
            ...
            <div class="mt-5">
                ...
                <div v-if="Object.keys(fixture).length > 0" ref="captureRef">
                    <div v-for="(rounds, phase) in fixture" :key="phase" class="mb-12">
                        ...
                        <div v-for="(matches, roundNumber) in rounds" :key="roundNumber" class="mb-8">
                            ...
                            <div class="flex items-center gap-4 mb-4">
                                <span class="bg-red-600 text-white px-3 py-1 rounded-full text-sm font-bold shadow-sm">
                                    FECHA {{ roundNumber }}
                                </span>
                                <div class="h-[1px] bg-gray-200 flex-grow dark:bg-gray-700"></div>
                            </div>
