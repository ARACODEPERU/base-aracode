                ...
                <table class="w-full border-collapse border-spacing-0">
                    <tbody>
                        <tr>
                            ...
                            <td class="align-top">
                                <p class="font-bold">Documento que Modifica</p>
                            </td>
                        </tr>
                        <tr>
                            <td class="w-1/2 align-top">
                                <div class="text-neutral-600 text-xs">
                                    ...
                                    <p>
                                        @if ($document->getTipDocAfectado() == '01')
                                            <strong>RUC:</strong>
                                        @elseif($document->getTipDocAfectado() == '03')
                                            <strong>N/D:</strong>
                                        @endif
                            ...
                            <td class="w-1/2 align-top">
                                <div class="text-xs text-neutral-600">
                                    <p>Denominacíon: {{ $document->getTipDocAfectado() == '01' ? 'FACTURA' : 'BOLETA DE VENTA' }}</p>
                                    <p>Fecha Emisión: {{ $document->getFechaDocAfectado()->format('d/m/Y') }}</p>
                                    <p>Nro. : {{ $document->getNumDocfectado() }}</p>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <blockquote>
                                                    ...
                                                    <span>Representación Impresa de la NOTA DE {{ $document->getTipoDoc() == '07' ? 'CRÉDITO' : 'DÉBITO' }} ELECTRÓNICA.</span>
                                                </blockquote>
                                            </td>
                                        </tr>
                                    </tbody>
