    ...
    <AppLayout title="Compras">
        <Navigation :routeModule="route('purchases_dashboard')" :titleModule="'Compras'">
            <li class="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                <Link :href="route('purc_documents_list')" class="text-primary hover:underline">Lista de Documentos</Link>
            </li>
            <li class="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                <span>Nuevo</span>
            </li>
                ...
                <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                    <div class="flex justify-between items-center pb-4 border-b border-gray-200 dark:border-gray-700 mb-3">
                        <div style="width: 180px;" class="text-4xl uppercase font-bold">
                            <select v-model="formDocument.sale_documenttype_id" class="form-select">
                        ...
                        <div class="flex-1 pr-4 ">
                            <div class="grid grid-cols-3 gap-4 justify-between mb-1">
                                ...
                                <div class="col-span-3 sm:col-span-2 ltr:text-right rtl:text-left">
                                    <input @click="openModalSupplierSearch" @input="openModalSupplierSearch" :value="formDocument.supplier_name" class="form-input py-1.5 text-xs" type="text" />
                                    <SearchSupplier 
                            ...
                            <div class="grid grid-cols-3 gap-4 justify-between mb-1">
                                ...
                                <div class="col-span-3 sm:col-span-2 ltr:text-right rtl:text-left">
                                    <input :value="formDocument.supplier_ubigeo_description" class="form-input py-1.5 text-xs" disabled type="text" />
                                </div>
                            </div>
                            <div class="grid grid-cols-3 gap-4 justify-between mb-1">
                                <div style="font-size: 14px;" class="col-span-3 sm:col-span-1 uppercase">Dirección:</div>
                                <div class="col-span-3 sm:col-span-2 ltr:text-right rtl:text-left">
                                    <input :value="formDocument.supplier_direction" class="form-input py-1.5 text-xs" disabled type="text" />
                                </div>
                            </div>
                        </div>
                        <div class="flex-1">
                            <div class="flex justify-between mb-1">
                                <div class="flex">
                                    ...
                                    <div class="flex-1 ltr:text-right rtl:text-left">
                                        <input v-model="formDocument.serie" class="form-input py-1.5 text-xs" type="text" />
                                ...
                                <div class="flex">
                                    ...
                                    <div class="flex-1 ltr:text-right rtl:text-left">
                                        <input v-model="formDocument.number" class="form-input py-1.5 text-xs" type="text" />
                            ...
                            <div class="flex justify-between mb-1">
                                ...
                                <div class="flex-1 ltr:text-right rtl:text-left">
                                    <input v-model="formDocument.date_issue" class="form-input py-1.5 text-xs" type="date" />
                            ...
                            <div class="flex justify-between mb-1">
                                ...
                                <div class="flex-1 ltr:text-right rtl:text-left">
                                    <input v-model="formDocument.date_end" class="form-input py-1.5 text-xs" type="date" />
                                ...
                                <tr class="bg-gray-100 dark:bg-gray-900 dark:bg-opacity-20">
                                    <th style="width: 60px;" class="text-right py-1">
                                        <div class="flex items-center justify-center gap-2">
                                            <button @click="newItems" type="button" title="Agregar Nuevo" class="btn btn-sm btn-outline-success">
                                    ...
                                    <template v-for="(row, key) in formDocument.items">
                                        <tr>
                                            ...
                                            <td class="">
                                                ...
                                                class="form-input py-1.5 text-xs" type="text" />
                                            </td>
                                            ...
                                            <td style="width: 110px;" class="text-right ">
                                                ...
                                                class="form-input py-1.5 text-xs" disabled type="text" />
                        ...
                        <table class="table-bordered w-full ltr:text-left rtl:text-right text-gray-600">
                            <tbody>
                                <tr v-for="(row, index) in formDocument.payments" v-bind:key="index">
                                    ...
                                    <td>
                                        <input v-model="row.reference" type="text" id="first_name" class="form-input py-1.5 text-xs" placeholder="Referencia">
                                        <InputError :message="formDocument.errors[`payments.${index}.reference`]" class="mt-2" />
                                    </td>
                                    <td style="width: 110px;">
                                        <input v-model="row.amount" type="text" id="first_name" class="form-input py-1.5 text-xs" placeholder="Monto" required>
